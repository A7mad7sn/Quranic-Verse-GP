      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10), // Added spacing between text field and radio buttons
            Row(
              mainAxisAlignment: MainAxisAlignment.center, // Centering the radio buttons horizontally
              children: [
                Radio(
            ...
            ElevatedButton(
              style: ButtonStyle(backgroundColor:MaterialStatePropertyAll(Color.fromRGBO(232, 223, 195, 1))),
              onPressed: () {
                searchVerses();
                setState(() {
                  isSearched = true;
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        'الأية ${result['Verse Number']}: ${result['Verse'] ?? ''}',
                      ),
                      trailing: selectedRadio == 3
                          ? IconButton(
                              ...
                              onPressed: () {
                                showDialog(
                                  ...
                                  builder: (context) => AlertDialog(
                                    title: Text('Tafseer'),
                                    content: Text(result['Tafseer'] ?? 'No Tafseer available'),
                                    actions: [
                                      TextButton(
                                        onPressed: () {
